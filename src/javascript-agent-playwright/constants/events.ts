export const EVENT_NAMES = {
  ...
  ATTACH_TEST_ACTION: 'zebrunner:attach-test-action',
  ...
  ATTACH_TEST_VIDEO: 'zebrunner:attach-test-video',
  ATTACH_TEST_SESSION_CAPABILITIES: 'zebrunner:attach-test-session-capabilities',
