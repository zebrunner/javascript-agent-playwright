...
exports.ZEBRUNNER_PATHS = void 0;
exports.ZEBRUNNER_PATHS = {
    ...
    UPDATE_TEST_SESSION: (launchId, testSessionId) => `/api/reporting/v1/test-runs/${launchId}/test-sessions/${testSessionId}`,
    FINISH_TEST_SESSION: (launchId, testSessionId) => `/api/reporting/v1/test-runs/${launchId}/test-sessions/${testSessionId}`,
    UPDATE_TCM_CONFIGS: (launchId) => `/api/reporting/v1/test-runs/${launchId}/tcm-configs`,
    UPSERT_TEST_TEST_CASES: (launchId, testId) => `/api/reporting/v1/test-runs/${launchId}/tests/${testId}/test-cases:upsert`,
    ...
    ATTACH_TEST_ARTIFACT_REFERENCES: (launchId, testId) => `/api/reporting/v1/test-runs/${launchId}/tests/${testId}/artifact-references`,
    ...
    UPLOAD_TEST_SESSION_ARTIFACT: (launchId, testSessionId) => `/api/reporting/v1/test-runs/${launchId}/test-sessions/${testSessionId}/artifacts`,
};
