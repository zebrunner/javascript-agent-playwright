...
class ReportingConfig {
    ...
    constructor(config) {
        ...
        this.launch = {
            displayName: getString('REPORTING_LAUNCH_DISPLAY_NAME', config?.launch?.displayName, (0, helpers_1.isNotBlankString)(process.env.npm_package_name) ? process.env.npm_package_name : 'Default Suite'),
